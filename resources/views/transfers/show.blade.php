		...
		<div class="page-header-container">
			...
			<div class="header-actions">
				@if($transfer->status_id === $status::PENDING)
					<a href="{{ route('inventory.transfers.edit', $transfer) }}" class="btn btn-primary" style="margin-right: 0.5rem; background-color: #2563eb; color: white; border-color: #2563eb;">
