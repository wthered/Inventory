		...
		protected function prepareForValidation(): void {
			if ($this->has('quantity')) {
				...
				$this->merge([
					...
					'quantity' => filter_var($this->input('quantity'), FILTER_VALIDATE_INT) ?? 0,
				]);
			}
		}
...
//			$this->merge([
//				'product_id'   => $this->validated('inputData.product'),
//				'warehouse_id' => $this->validated('inputData.warehouse'),
//				'location_id'  => $this->validated('inputData.location'),
//				'inventory_id' => $this->validated('inputData.inventory'),
//				'quantity'     => trim($this->validated('quantity')),
//			]);
//		}
	}
