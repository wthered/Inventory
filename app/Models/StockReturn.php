<?php
	...
	class StockReturn extends Model implements StockMovementHeader {
		use SoftDeletes, LogsActivity, HasStockMovement;
		...
		*/
		...
		public static function generateRmaNumber(StockReturn $return): string {
			...
			$typeLetter = ($return->returnable_type === 'App\Models\Supplier') ? 'S' : 'C';
		...
		/**
		 * Computed Attribute: How many items actually go back to the shelf.
		 */
		public function getRestockableQuantityAttribute(): int {
			return (int) ($this->quantity * ($this->restock_percentage / 100));
		}
		...
		*/
		...
		public function getIsProcessedAttribute(): bool { return $this->status === 'completed'; }
		...
		public function getMovementReason(): string {
			...
			return TransactionReason::CUSTOMER_RETURN_IN->value;
		}
